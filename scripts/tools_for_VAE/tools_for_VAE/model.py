...
#### Create encooder
def build_encoder_resnet(latent_dim, hidden_dim, filters, kernels,nb_of_bands, conv_activation='softplus', dense_activation='softplus'):
    """
    Return encoder as model
    latent_dim : dimension of the latent variable
    hidden_dim : dimension of the dense hidden layer
...
#### Create encooder
def build_decoder_resnet(input_shape, latent_dim, hidden_dim, filters, kernels, conv_activation='softplus', dense_activation='softplus'):
    """
    Return decoder as model
    input_shape: shape of the input data
    latent_dim : dimension of the latent variable
...
def vae_model_resnet(latent_dim, nb_of_bands):
    """
    Function to create VAE model
    nb_of bands : nb of band-pass filters needed in the model
    """
    ...
    # Build the encoder
    encoder = build_encoder_resnet(latent_dim, hidden_dim, filters, kernels, nb_of_bands)
    # Build the decoder
    decoder = build_decoder_resnet(input_shape, latent_dim, hidden_dim, filters, kernels, conv_activation=None, dense_activation=None)
...
#### Create encooder
def build_encoder_dropout(latent_dim, hidden_dim, filters, kernels,nb_of_bands, conv_activation='softplus', dense_activation='softplus'):
    """
    Return encoder as model
    latent_dim : dimension of the latent variable
    hidden_dim : dimension of the dense hidden layer
...
#### Create encooder
def build_decoder_dropout(input_shape, latent_dim, hidden_dim, filters, kernels, conv_activation='softplus', dense_activation='softplus'):
    """
    Return decoder as model
    input_shape: shape of the input data
    latent_dim : dimension of the latent variable
...
# Function to define model with dropout layers

def vae_model_dropout(latent_dim, nb_of_bands):
    """
    Function to create VAE model
    nb_of bands : nb of band-pass filters needed in the model
    """
    ...
    # Build the encoder
    encoder = build_encoder_dropout(latent_dim, hidden_dim, filters, kernels, nb_of_bands)
    # Build the decoder
    decoder = build_decoder_dropout(input_shape, latent_dim, hidden_dim, filters, kernels, conv_activation=None, dense_activation=None)

    
    return encoder, decoder


def vae_model_3(latent_dim, nb_of_bands):
    """
    Function to create VAE model
    nb_of bands : nb of band-pass filters needed in the model
    """
...
def vae_model_5(latent_dim, nb_of_bands):
    """
    Function to create VAE model
    nb_of bands : nb of band-pass filters needed in the model
    """
