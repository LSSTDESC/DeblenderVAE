...
coeff_exp = [coeff_exp_euclid*N_exposures_euclid] + [coeff_exp_lsst* N_exposures_lsst[0]]+ [coeff_exp_lsst* N_exposures_lsst[1]]+[coeff_exp_lsst* N_exposures_lsst[2]]+[coeff_exp_lsst* N_exposures_lsst[3]]+[coeff_exp_lsst* N_exposures_lsst[4]]+[coeff_exp_lsst* N_exposures_lsst[5]]
