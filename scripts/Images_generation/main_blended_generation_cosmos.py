...
save_dir = '/sps/lsst/users/barcelin/data/blended_images/28/miscenter/' + training_or_test
...
for icat in trange(N_files):
    ...
    res = utils.apply_ntimes(image_generator, N_per_file, (cosmos_cat, training_or_test,5, used_idx, nmax_blend, 100, 28.))
