...
save_dir = '../../images/blended/' + training_or_test
...
keys = ['nb_blended_gal', 'SNR', 'SNR_peak', 'redshift', 'moment_sigma', 'e1', 'e2', 'mag', 'closest_x', 'closest_y', 'closest_redshift', 'closest_moment_sigma', 'closest_e1', 'closest_e2', 'closest_mag', 'blendedness_total_lsst', 'blendedness_total_euclid', 'blendedness_closest_lsst', 'blendedness_closest_euclid']
...
for icat in trange(N_files):
    ...
    res = ca.parallel.apply_ntimes(blend_generator, N_per_file, (cosmos_cat, training_or_test, used_idx, nmax_blend, 100))
