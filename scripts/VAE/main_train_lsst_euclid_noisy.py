...
path_output = '/sps/lsst/users/barcelin/weights/LSST_EUCLID/VAE/noisy/v9/bis3/mse/'
...
# Load weights
vae, vae_utils, encoder, Dkl = utils.load_vae_conv(os.path.join(path_output, 'weights'), 10, folder=True) 
...
#######
# Callback
path_weights = '/sps/lsst/users/barcelin/weights/LSST_EUCLID/VAE/noisy/v9/bis4/'
path_plots = '/sps/lsst/users/barcelin/callbacks/LSST_EUCLID/VAE/noisy/v9/bis4/'
