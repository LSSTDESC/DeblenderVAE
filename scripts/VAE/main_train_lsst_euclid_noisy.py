...
path_output = '/home/ubuntu/deblending/Deblender_VAE/training/VAE/LSST_Euclid'

######## Import data for callback (Only if VAEHistory is used)
x_val = np.load(os.path.join(images_dir, 'validation/galaxies_isolated_20190914_0_images.npy'))[:,:,bands].transpose([0,1,3,4,2])
...
callbacks = [checkpointer_loss, vae_hist, ReduceLROnPlateau(), TerminateOnNaN()]# checkpointer_mse earlystop, checkpointer_loss,vae_hist,, alphaChanger
