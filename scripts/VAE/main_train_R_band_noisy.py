...
path_output = '/sps/lsst/users/barcelin/weights/R_band/VAE/noisy/v27/mse/'#v21/bis_bis/mse/
...
#######
# Callback
path_weights = '/sps/lsst/users/barcelin/weights/R_band/VAE/noisy/v27/'
path_plots = '/sps/lsst/users/barcelin/callbacks/R_band/VAE/noisy/v27/'
