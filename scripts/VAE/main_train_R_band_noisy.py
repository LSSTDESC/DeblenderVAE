...
x_val= np.load('/sps/lsst/users/barcelin/data/single_galaxies/28/miscenter_19112019/validation/galaxies_isolated_20191024_0_images.npy', mmap_mode = 'c')[:500,:,bands].transpose([0,1,3,4,2])
