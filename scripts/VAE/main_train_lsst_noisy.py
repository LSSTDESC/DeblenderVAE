...
training_generator = BatchGenerator_lsst(list_of_samples,total_sample_size=1800, batch_size= batch_size, training_or_validation = 'training', noisy = True)#180000
validation_generator = BatchGenerator_lsst(list_of_samples,total_sample_size=200, batch_size= batch_size, training_or_validation = 'validation', noisy = True)#20000
