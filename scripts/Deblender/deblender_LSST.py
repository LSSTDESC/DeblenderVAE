...
path_output = '/sps/lsst/users/barcelin/weights/LSST/deblender/noisy/v6/train_4/'
...
x_val = np.load(os.path.join(images_dir, 'galaxies_blended_1_v5.npy'))[:500,1,:,bands].transpose([0,1,3,4,2])
